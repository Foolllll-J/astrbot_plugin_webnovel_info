...
一款为 [**AstrBot**](https://astrbot.app) 设计的跨平台网文搜索与详情查询插件。它能查询**起点**、**刺猬猫**、**七猫**、**飞卢**和**菠萝包**等平台的小说信息，同时具有**书架管理**功能。

---

## 🚀 特性

* ​**单平台精准搜索**​: 支持起点、刺猬猫、七猫、飞卢、菠萝包等多平台书籍搜索与详情查询。
...
* 如果您在使用中遇到错误或有改进建议，请提交 [Issue](https://github.com/Foolllll-J/astrbot_plugin_webnovel_info/issues)，交流群不受理插件问题。
